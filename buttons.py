...
#  raspbian(os), or equivlent with the additional python packages below
#  rpi model (b)2 or later (for the 40 gpio pinout)
# Purpose: to provide hardware keys to vlc (or rather the os globally)
...
# power_off (if left upper buttons both pressed)
        if button_state[0] == 0 and button_state[1] == 0:
            #keypress(opcodes['power_off'))
